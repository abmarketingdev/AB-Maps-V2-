 ...
 */
export const createCampaignForm = async (formData, token) => {
  try {
 ...
 */
export const getCampaignFormsByCampaign = async (campaignId, token) => {
  try {
 ...
 * @returns {Promise<Array>} Array of campaign forms
 */
export const getCampaignFormsBySalesRep = async (salesRepId, token) => {
  try {
 ...
 * @returns {Promise<Array>} Array of campaign forms
 */
export const getMyCampaignForms = async (token) => {
  try {
 ...
 */
export const updateCampaignFormStatus = async (formId, status, token) => {
  try {
...
export const getCurrentUser = async (token) => {
  try {
    const response = await fetch(`${API_CONFIG.backend.baseUrl}/api/users/me/`, {
      method: 'GET',
      headers: getAuthHeaders(token)
    });
