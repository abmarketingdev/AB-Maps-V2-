...
/**
 * Status configuration with colors and icons - Modern palette
 */
const STATUS_CONFIG = {
  ja: {
    label: 'Ja',
...
/**
 * ApartmentListItem Component (Employee App)
 *
 * Nei: two-step — pick Nei, then reason (or Ikke spesifisert). PATCH always includes
 * `nei_subcategory` for Nei (string or null). Notes are only sent together with status
 * from this UI (no separate notes-only PATCH).
 */
