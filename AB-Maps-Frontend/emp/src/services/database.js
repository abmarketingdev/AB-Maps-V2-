...
export const saveAddressStatus = dbService.saveAddressStatus.bind(dbService);
export const getAllAddressStatuses = dbService.getAllAddressStatuses.bind(dbService);
export const isApartmentBuilding = dbService.isApartmentBuilding.bind(dbService);
export const getApartmentsForBuilding = dbService.getApartmentsForBuilding.bind(dbService);
